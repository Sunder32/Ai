...
ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='localhost,127.0.0.1,illicitly-frank-bulbul.cloudpub.ru,legally-matchless-bulldog.cloudpub.ru,.cloudpub.ru').split(',')
